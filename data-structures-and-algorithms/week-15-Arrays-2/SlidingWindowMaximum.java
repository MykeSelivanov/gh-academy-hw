class Solution {
    public int[] maxSlidingWindow(int[] nums, int k) {
        ...
        // Creaate the array of maximums of each window
        ...
        for (int i = 0; i + k - 1 < n; i++) {
            // Current window boundaries are a[i ... i+k-1]
            // When k = 1, it's just a[i]
            // When k = 2, it's a[i ... i+1]
            // When k = n, it's the whole array a[0 ... n-1]
            int l = i;
            int r = i + k - 1;
